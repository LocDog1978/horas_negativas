...
<html lang="pt-br">
	...
	<!-- head -->
		...
		<title>GedUERJ - 403 | Sistema de Controle de Documentos</title>
			...
			<div class="col-md-12">
				<div class="col-middle" style="margin-top: 10px;">
					...
					<div class="text-center text-center">
						...
						<p>Você não é dev e/ou administrador do sistema!</p>
						<img src="<?php echo base_url('../assets/img/403.gif'); ?>" width="1000">
						<br>
					</div>
				</div>
			</div>
